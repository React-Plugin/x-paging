    ...
    function Paging(props) {
        ...
        _this.renderContent = function (local, localCode) {
            ...
            return _react2.default.createElement(
                "div",
                { className: "x-paging", ref: function ref(_ref) {
                        return _this.pager = _ref;
                    } },
                _react2.default.createElement(
                    "button",
                    { title: local.first, onClick: _this.goFirst, className: _this.state.isFirst ? 'disabled' : '' },
                    _react2.default.createElement("i", { className: "xui icon-last" })
                ),
                _react2.default.createElement(
                    "button",
                    { title: local.prev, onClick: _this.goPrev, className: _this.state.isFirst ? 'disabled' : '' },
                ...
                _react2.default.createElement(
                    "button",
                    { title: local.next, onClick: _this.goNext, className: _this.state.isLast ? 'disabled' : '' },
                    _react2.default.createElement("i", { className: "xui icon-next" })
                ),
                _react2.default.createElement(
                    "button",
                    { title: local.last, onClick: _this.goLast, className: _this.state.isLast ? 'disabled' : '' },
                    _react2.default.createElement("i", { className: "xui icon-next1" })
                ),
                _this.renderPageSize()
            );
        };
    ...
    _createClass(Paging, [{
        ...
        value: function renderPageSize() {
            ...
            if (pageSizeOptions.length > 0) {
                ...
                return _react2.default.createElement(
                    "select",
                    { title: _zh_CN2.default.recordPage, value: this.state.pagesize, onChange: this.changePageSize },
                    options
                );
            }
        }
